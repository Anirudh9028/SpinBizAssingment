...
public class report implements ITestListener
{
	...
	{
		htmlReporter = new ExtentSparkReporter(".\\report\\AltroMutualAssingmentReport.html");
		...
		htmlReporter.config().setDocumentTitle("Altro Mutual");
		htmlReporter.config().setReportName("Altro Mutual Assingment");
